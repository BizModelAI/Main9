...
export class MemStorage implements IStorage {
  ...
  async saveAIContent(
    ...
    return Promise.resolve({
      id: 1, // Placeholder, actual ID will be generated by DB
      quizAttemptId,
      contentType,
      content,
      contentHash: "placeholder", // Placeholder, actual hash will be generated
  ...
  async getAIContent(
    ...
    const attempt = this.quizAttempts.get(quizAttemptId);
    if (attempt?.aiContent && (attempt.aiContent as Record<string, any>)[contentType]) {
      return {
        id: 0,
        quizAttemptId,
        contentType,
        content: (attempt.aiContent as Record<string, any>)[contentType],
        contentHash: null,
        generatedAt: new Date(),
        createdAt: new Date(),
      };
